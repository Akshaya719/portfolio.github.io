...
const certificates = [
    {
        ...
        credentialUrl: '/certificates/Cloud Computing.pdf',
        isAvailable: true,
        brandColor: '#FF9900'
    },
    {
        ...
        credentialUrl: '/certificates/walmat forage certificate .pdf',
        isAvailable: true,
        brandColor: '#0071CE'
    },
    {
        ...
        credentialUrl: '/certificates/nodejs_basic certificate.pdf',
        isAvailable: true,
        brandColor: '#2EC866'
    },
    {
        ...
        credentialUrl: '/certificates/java_basic certificate.pdf',
        isAvailable: true,
        brandColor: '#E76F00'
    },
];
